...
class BudgetCategory {
  ...
  BudgetCategory({required this.name, required this.startingBudget, required this.history});
  ...
  Map<String, dynamic> toJson() => {'name': name, 'startingBudget': startingBudget, 'history': history.map((e) => e.toJson()).toList()};
